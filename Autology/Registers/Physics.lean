...
physics. A different physics register may map differently and is equally Autology. The register stays in
...
/-- **The GR/QM boundary is the open seam (6.7).** Approachable from either side, never closing. Toward the
